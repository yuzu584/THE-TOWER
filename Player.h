...
constexpr float PLAYER_MOVE_SPEED        = 0.1f; // 移動速度
constexpr float PLAYER_JUMP_POWER        = 0.1f; // ジャンプ力
constexpr float PLAYER_GRAVITY           = 0.1f; // 重力
...
constexpr float PLAYER_ENUM_DEFAULT_SIZE = 2.0f; // 周囲のポリゴン検出に使用する球の初期サイズ
